...
public class RedisJodisBloomFilter {
     ...
     */
    public RedisJodisBloomFilter(int numApproxElements, double fpp, JedisResourcePool jedisResourcePool) {
